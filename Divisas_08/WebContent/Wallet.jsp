...
<button onClick="createTestWallet()">Create Test Wallet</button>
<button onClick="add500ToTestWallet()>Add 500 to Test Wallet</button>
<button onClick="withdraw100FromTestWallet()">Withdraw 100 From Test Wallet</button>
