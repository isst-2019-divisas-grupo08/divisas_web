...
<body>
    ...
    <div class="selectors">
    <img class="imgLogo" height="500px" width="1325px" src="Assets/Img/bannertrips.jpg">
	    ...
	    <form method="post" action="WalletServlet">
	    			<select>
					<option>inmediato</option>
					<option>a tres dias</option>
	...
	<div class="footer">
	<br>
	    <img class="imgLogo" height="500px" width="1325px" align="center" src="Assets/Img/footer.jpg">
	</div>
